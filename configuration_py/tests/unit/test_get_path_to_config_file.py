...
class TestGetPathToConfigFile(TestCase):
    @patch('configuration_py.configuration_py._get_paths_existed_file', return_value=['/path/to/config/test.yaml'])
    ...
    @patch('configuration_py.configuration_py._get_paths_existed_file', return_value=[])
    ...
    @patch('configuration_py.configuration_py._get_paths_existed_file', return_value=['/path/test.yaml', '/path/test.yml'])
