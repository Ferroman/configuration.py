...
from configuration_py.configuration_py import _generate_possible_paths_to_config


class TestGeneratePossiblePathsToConfig(TestCase):
    @patch('configuration_py.configuration_py._generate_possible_config_file_names', return_value=['testconfig.yaml'])
