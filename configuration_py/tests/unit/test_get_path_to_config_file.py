...
class TestGetPathToConfigFile(TestCase):
    @patch('configuration_py.configuration_py._find_existing_config_file', return_value=['/path/to/config/test.yaml'])
    ...
    @patch('configuration_py.configuration_py._find_existing_config_file', return_value=[])
    ...
    @patch('configuration_py.configuration_py._find_existing_config_file', return_value=['/path/test.yaml', '/path/test.yml'])
